...
let checkAndSet = () => {
    ...
    let brother = document.querySelector(".video-toolbar-right-item.toolbar-right-complaint");
	...
	if (brother && brother.parentElement.childElementCount > 1) {
		...
		div.classList = ["video-complaint video-toolbar-right-item toolbar-right-complaint"];
...
skipAutoNext = setInterval( checkSkip, 2000 );
